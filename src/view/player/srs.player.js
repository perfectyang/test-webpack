...
export function SrsPlayer(container, width, height, private_object) {
    if (!SrsPlayer.__id) {
        SrsPlayer.__id = 100;
    }
    ...
    this.srs_player_url = "./srs_player.swf?_version="+srs_get_version_code();
...
SrsPlayer.prototype.start = function(url) {
    ...
    var attributes = {};
    var self = this;
    console.log('srs_player_url', this.srs_player_url) 
    ...
    swfobject.embedSWF(
        ...
        function(callbackObj){
            console.log('callbackOjb', callbackObj)
